...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 30; i++) {// new
            ...
            /*
             * long time4 = System.currentTimeMillis(); mgr.processGA(); long
             * time41 = System.currentTimeMillis();
             * System.out.println("processGA: " + (time41-time4) + "ms"); long
             * time34 = System.currentTimeMillis(); mgr.processRIA(); long
