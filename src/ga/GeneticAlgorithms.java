...
public class GeneticAlgorithms {
    ...
    public GeneticAlgorithms(int SizeOfPops, List<SourceClassInfo> listOfGA, double pc, double pm,
            int GenerationOfPops) {
    ...
    public void generateClassListBasedGA(int SizeOfPops, List<SourceClassInfo> listOfGA) {
        ...
        System.out.println(
                "global_best_fitness" + global_bestchromos.calculateFitness(global_bestchromos.getListOfSCI()));
        System.out
                .println("fit_attr" + global_bestchromos.calculateAttributeFitness(global_bestchromos.getListOfSCI()));
