...
/*
 * 测试代码 System.out.println("newPopulations's number" +
 ...
 */
/*
 * 测试代码 System.out.println("sortpopulations-----" + sortpopulations.size());
 * for( Chromosome ch : sortpopulations){
 * System.out.println("这是sortpopulations的一个染色体个体------"); List<SourceClassInfo>
 * a = ch.getListOfSCI(); for(SourceClassInfo sci : a){
 * System.out.println(sci.className()); } }
 * System.out.println("------sort---chrom------");
 */
/*
 * 测试代码 System.out.println("sortpopulations-----" + sortpopulations.size()); int
 * i=1; for( Chromosome ch : sortpopulations){
 * System.out.println("这是sortpopulations的第"+i+"个染色体个体------"); i++;
 * System.out.println("该染色体方法依赖数目为"+ch.getNumberOfMethodDependency(ch.
 * getListOfSCI()));
 ...
 * System.out.println(ch.getFitness()); System.out.println("----该染色体的所有类-----");
