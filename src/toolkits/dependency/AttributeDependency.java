...
public class AttributeDependency implements IDependency {
    ...
    public AttributeDependency(SourceClassAttribute dParent, TargetClass dChild, String type, boolean b_succ) {
    ...
    public String toDump() {
        ...
        sb.append(type + "\t" + dp_class + "\t" + dp_method + "\t" + dp_ln + "\t" + dp_vn + "\t" + dc_class + "\t"
                + b_succ + "\n");
