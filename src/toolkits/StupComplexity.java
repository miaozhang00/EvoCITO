...
public class StupComplexity {
    ...
    public SourceClassInfo newSourceClassInfo(String className, boolean b_interface, boolean b_abstract) {
    ...
    public SourceClassInfo newSourceClassInfo(String className) {
    ...
    public SourceClassInfo getSourceClassInfo(String className) {
